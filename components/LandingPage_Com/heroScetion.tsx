        ...
        <div className="max-w-3xl mx-auto px-4 pt-20 md:pt-28 text-center mb-10">
            ...
            <div className="space-y-6 text-gray-600">
                <p className="text-center">
                    Transform your career without breaking the bank,from the best online creators.
                </p>
                {/* <div>
            ...
            <div>
                ...
                <Button size="lg" className="bg-green-500 hover:bg-green-600 text-white mt-10 group">
                    Getting Start
